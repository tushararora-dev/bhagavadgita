...
def display_home(chapter_names):
    ...
    with col1:
        img_path = "attached_assets/generated_images/2.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 2: Sankhya Yoga (Yoga of Knowledge)")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/generated_images/3.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 3: Karma Yoga (Yoga of Action)")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/generated_images/4banner.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 4: Jnana Karma Sannyasa Yoga (Yoga of Knowledge, Renunciation, and Action)")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/generated_images/5.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 5: Karma sanyasa Yoga (Yoga of Renunciation of Action)")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/generated_images/6.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col1:
        img_path = "attached_assets/generated_images/7.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col1:
        img_path = "attached_assets/generated_images/10main.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 10: Vibhuti Yoga (Yoga of Divine Glories)")
    with col3:
        st.markdown(
    ...
    with col2:
        st.markdown(" ## Chapter 11: Vishwarupa Darshana Yoga (Vision of the Cosmic Form)")
    with col3:
        st.markdown(
    ...
    with col1:
        img_path = "attached_assets/generated_images/12main.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 12: Bhakti Yoga (The Yoga of Devotion)")
    with col3:
        st.markdown(
    ...
    with col2:
        st.markdown(" ## Chapter 13: Kshetra Kshetrajna Vibhaga Yoga (Yoga of Discriminating between the Field and the Knower of the Field)")
    with col3:
        st.markdown(
            '<a href="?chapter=13#top" target="_self" '
            'style="display:inline-block;padding:10px 14px;border-radius:8px;'
            'border:2px solid orange;color:oldlace;background:#0D0B1A;'
            'text-decoration:none;">Read More ▶</a>',
            unsafe_allow_html=True
    ...
    with col1:
        img_path = "attached_assets/generated_images/14main.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 14: Guna-Traya Vibhaga Yoga (oga of the Classification of the Three Gunas)")
    with col3:
        st.markdown(
            '<a href="?chapter=14#top" target="_self" '
            'style="display:inline-block;padding:10px 14px;border-radius:8px;'
            'border:2px solid orange;color:oldlace;background:#0D0B1A;'
            'text-decoration:none;">Read More ▶</a>',
            unsafe_allow_html=True
    ...
    with col2:
        st.markdown(" ## Chapter 15: Purushottama Yoga (Yoga of the Supreme Person)")
    with col3:
        st.markdown(
            '<a href="?chapter=15#top" target="_self" '
            'style="display:inline-block;padding:10px 14px;border-radius:8px;'
            'border:2px solid orange;color:oldlace;background:#0D0B1A;'
            'text-decoration:none;">Read More ▶</a>',
            unsafe_allow_html=True
    ...
    with col2:
        st.markdown(" ## Chapter 16: Daivi-Asuri Sampad Vibhaga Yoga (The Yoga of the Division Between Divine and Demoniac Qualities)")
    with col3:
        st.markdown(
            '<a href="?chapter=16#top" target="_self" '
            'style="display:inline-block;padding:10px 14px;border-radius:8px;'
            'border:2px solid orange;color:oldlace;background:#0D0B1A;'
            'text-decoration:none;">Read More ▶</a>',
            unsafe_allow_html=True
    ...
    with col1:
        img_path = "attached_assets/generated_images/17main.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 17: Shraddha Traya Vibhag Yog (Yoga of the Threefold Division of Faith)")
    with col3:
        st.markdown(
            '<a href="?chapter=17#top" target="_self" '
            'style="display:inline-block;padding:10px 14px;border-radius:8px;'
            'border:2px solid orange;color:oldlace;background:#0D0B1A;'
            'text-decoration:none;">Read More ▶</a>',
            unsafe_allow_html=True
    ...
    with col1:
        img_path = "attached_assets/generated_images/18main.jpg"
        if os.path.exists(img_path):
            st.image(img_path, use_container_width=True)
        else:
            st.markdown("🛠️ Working on it...")
    ...
    with col2:
        st.markdown(" ## Chapter 18: Moksha-Sannyasa Yoga (Yoga of Liberation and Renunciation)")
    with col3:
        st.markdown(
            '<a href="?chapter=18#top" target="_self" '
            'style="display:inline-block;padding:10px 14px;border-radius:8px;'
            'border:2px solid orange;color:oldlace;background:#0D0B1A;'
            'text-decoration:none;">Read More ▶</a>',
            unsafe_allow_html=True
...
def main():
    ...
    *, body, html {{
    ...
    st.title("Shrimad Bhagavad Gita")
